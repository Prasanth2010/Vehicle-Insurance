                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-2 pt-4 border-t border-gray-200">
                      <button
                        ...
                        className="flex-1 px-3 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors flex items-center justify-center"
                      >
