// src/pages/surveyor/SurveyorProfile.jsx
...
export default function SurveyorProfile() {
  ...
  // Fetch fresh surveyor data from backend on mount
  useEffect(() => {
    if (!user || !user.id) {
      navigate('/login');
      return;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-16 w-16 border-6 border-indigo-600 border-t-transparent"></div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <p className="text-2xl mt-2 opacity-90">Field Surveyor</p>
                  <p className="text-xl mt-3 opacity-80">{profileData.email}</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={!isEditing}
                  className="w-full px-6 py-5 text-lg border-2 border-gray-300 rounded-2xl focus:ring-4 focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-50 transition-all"
                />
              </div>
